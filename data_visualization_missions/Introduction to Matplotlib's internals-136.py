...
ax.set_ylim([min(temperature),max(temperature)])
plt.show()
...
ax1.set(xlim=(0,13), ylim=(10,110), xlabel="Month", ylabel="Temperature", title="2013")
ax1.scatter(month_2013, temperature_2013, color='darkblue', marker='o') #add xlabel, ylabel, and title

ax2.set(xlim=(0,13), ylim=(10,110), xlabel="Month", ylabel="Temperature", title="2014")
ax2.scatter(month_2014, temperature_2014, color='darkgreen', marker='x') #add xlabel, ylabel, and title
